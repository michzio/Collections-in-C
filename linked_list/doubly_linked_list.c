...
void dl_list_travers_forward(const doubly_linked_list_t *list, data_handler_t handle_data) {
...
void dl_list_travers_backward(const doubly_linked_list_t *list, data_handler_t handle_data) {
...
void dl_list_insert_at_pos(doubly_linked_list_t *list, doubly_linked_node_t *pos, void *data, size_t data_size) {
    ...
    dl_wrap_data(list, new_node, data, data_size);

    dl_list_insert_node_at_pos(list, pos, new_node);
}

void dl_list_insert_node_at_pos(doubly_linked_list_t *list, doubly_linked_node_t *pos, doubly_linked_node_t *new_node) {

    if(pos == NULL) {
        dl_list_push_node_front(list, new_node);
        return;
    }
...
void dl_list_push_back(doubly_linked_list_t *list, void *data, size_t data_size) {
    ...
    dl_list_push_node_back(list, new_node);
}
...
void dl_list_pop_front(doubly_linked_list_t *list) {
    dl_list_remove_node(list, list->head);
}

void dl_list_pop_back(doubly_linked_list_t *list) {
    dl_list_remove_node(list, list->tail);
}
